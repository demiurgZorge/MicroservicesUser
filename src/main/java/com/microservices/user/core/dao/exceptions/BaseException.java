...
public class BaseException extends RuntimeException {
	...
	protected static final Logger defaultLogger = LoggerFactory.getLogger(BaseException.class);
    ...
    public static BaseException unknown(Logger logger, Throwable cause) {
        ...
        if (cause instanceof BaseException) {
            e = (BaseException)cause;
        }
        else {
            e = new BaseException(BaseErrors.UNKNOWN, cause);
        }
    ...
    public static BaseException create(ErrorCodeEnum error) {
    	return create(defaultLogger, error);
    }
